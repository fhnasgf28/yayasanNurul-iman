        ...
        <div className="flex flex-wrap mt-8 justify-between">
          <div className="md:w-1/2 w-full md:pl-2">
            <Text p className="!text-lg leading-relaxed">
              For any any queries related to this project / template feel free to connect with us at the given email. You can also post any comments on our{" "}
          ...
          <div className="md:w-1/3 w-full">
            ...
            <Text subtitle className="!font-light md:!text-3xl">
              yayasannurulimansiper@gmail.com
            </Text>
          </div>
        </div>
      </section>
